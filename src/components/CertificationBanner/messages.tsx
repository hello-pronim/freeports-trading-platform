const messages = {
    ...
    key_mismatch: `Your private key don't correspond to the one defined to your profile on server. Using computer of another user is not recommended. Please login back with correct user or delete the private key and import the correct one from your profile page.`
};
